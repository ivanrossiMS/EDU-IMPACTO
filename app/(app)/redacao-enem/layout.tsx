...
function ProvasLayoutInner({ children }: { children: React.ReactNode }) {
  ...
  if (accessState === 'denied') {
    return (
      <div style={{
        ...
        <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.4)', maxWidth: 400, margin: 0 }}>Você não possui acesso ao Módulo de Provas.</p>
