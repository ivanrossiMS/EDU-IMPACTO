...
const CAMPOS_DISPONIVEIS: { grupo: string; fonte: MapeamentoUsuario['fonte']; icone?: string; campos: { campo: string; label: string; exemplo: string; caminho?: string }[] }[] = [
  ...
  { grupo: 'Mãe', fonte: 'mae', icone: '👩', campos: [
    { campo: 'nome',            label: 'Nome completo',           exemplo: 'Ana Maria da Silva',   caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'cpf',             label: 'CPF',                     exemplo: '111.222.333-44',       caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'rg',              label: 'RG',                      exemplo: '11.222.333-4',         caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'orgEmissorRg',    label: 'Órgão emissor RG',       exemplo: 'SSP/SP',               caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'celular',         label: 'Celular',                 exemplo: '(11) 91111-1111',      caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'telefone',        label: 'Telefone fixo',           exemplo: '(11) 3000-0000',      caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'email',           label: 'E-mail',                  exemplo: 'mae@email.com',        caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'profissao',       label: 'Profissão',               exemplo: 'Professora',           caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'empresa',         label: 'Empresa/Empregadora',     exemplo: 'Escola Municipal',     caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'naturalidade',    label: 'Naturalidade',            exemplo: 'Santos/SP',            caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'uf',              label: 'UF',                      exemplo: 'SP',                   caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'nacionalidade',   label: 'Nacionalidade',           exemplo: 'Brasileira',           caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'estadoCivil',     label: 'Estado civil',            exemplo: 'Casada',               caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'renda',           label: 'Renda mensal',            exemplo: 'R$ 3.500,00',          caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'grauInstrucao',   label: 'Grau de instrução',      exemplo: 'Superior Completo',    caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'falecida',        label: 'Falecida',                exemplo: 'Não',                  caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
  ]},
  { grupo: 'Pai', fonte: 'pai', icone: '👨', campos: [
    { campo: 'nome',            label: 'Nome completo',           exemplo: 'Jose Carlos da Silva', caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'cpf',             label: 'CPF',                     exemplo: '555.666.777-88',       caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'rg',              label: 'RG',                      exemplo: '55.666.777-8',         caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'orgEmissorRg',    label: 'Órgão emissor RG',       exemplo: 'SSP/SP',               caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'celular',         label: 'Celular',                 exemplo: '(11) 92222-2222',      caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'email',           label: 'E-mail',                  exemplo: 'pai@email.com',        caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'profissao',       label: 'Profissão',               exemplo: 'Engenheiro',           caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'empresa',         label: 'Empresa/Empregadora',     exemplo: 'AutoPeças SA',         caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'naturalidade',    label: 'Naturalidade',            exemplo: 'Rio de Janeiro/RJ',    caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'estadoCivil',     label: 'Estado civil',            exemplo: 'Casado',               caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'renda',           label: 'Renda mensal',            exemplo: 'R$ 7.000,00',          caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'grauInstrucao',   label: 'Grau de instrução',      exemplo: 'Superior Completo',    caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
    { campo: 'falecido',        label: 'Falecido',                exemplo: 'Não',                  caminho: 'Acadêmico → Alunos → Matrícula → Filiação' },
  ]},
        ...
        <div style={{ padding: '24px 28px', display: 'flex', flexDirection: 'column', gap: 18 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gap: 14 }}>
            <div>
              ...
              <input className="form-input" value={nome} onChange={e => setNome(e.target.value)} placeholder="Ex: Declaração de Matrícula 2026" style={{ fontWeight: 600 }} />
            </div>
            <div>
