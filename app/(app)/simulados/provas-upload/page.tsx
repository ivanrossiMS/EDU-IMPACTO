              ...
              {groupedProvas.map(([serie, items]) => (
                ...
                return (
                  <motion.div key={prova.id}
                    ...
                    style={{ position: 'relative', background: 'hsl(var(--bg-surface))', border: '1px solid hsl(var(--border-subtle))', borderRadius: 16, padding: '24px', display: 'flex', flexDirection: 'column', gap: 24, transition: 'all 0.2s', marginTop: prova.titulo?.includes('ADAPTADO') ? 16 : 0 }}
