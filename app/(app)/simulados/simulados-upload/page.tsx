...
export default function UploadSimuladosGerenciamentoPage() {
  ...
  }, [simulados, search, filterStatus, filterBimestre, filterSerie, isProfView, currentUser?.id])
        ...
        {isCoord && (
          <div className="responsive-stats" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, marginBottom: 32 }}>
            {[
              ...
              { label: 'Aguardando Upload', sub: 'Enviados pelos professores', value: stats.aguardando, color: '#f59e0b', iconBg: 'rgba(245,158,11,0.06)', icon: Clock },
