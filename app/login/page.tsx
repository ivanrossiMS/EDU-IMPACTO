...
function Node({ x, y, Icon, delay, className = "" }: { x: string, y: string, Icon: any, delay: number, className?: string }) {
  return (
    <div 
...
function Particle({ x, y, size, delay, opacity = 0.4, className = "" }: { x: string, y: string, size: number, delay: number, opacity?: number, className?: string }) {
  return (
    <div 
