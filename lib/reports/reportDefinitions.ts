...
const F_TURNO: FilterDef = { key: 'turno', label: 'Turno', type: 'select', options: [{ value: '', label: 'Todos' }, { value: 'Matutino', label: 'Matutino' }, { value: 'Vespertino', label: 'Vespertino' }, { value: 'Integral/Intermediário', label: 'Integral/Intermediário' }] }
