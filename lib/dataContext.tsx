...
export const DEFAULT_PERFIS: Perfil[] = [
  ...
  { id: 'P7', nome: 'Administrador', cor: '#4b5563', descricao: 'Acesso administrativo completo', permissoes: ['principal','agenda-digital','academico','financeiro','rh','crm','portaria','administrativo','/administrativo/declaracao-irpf','bi','relatorios','multiUnidades','configuracoes','/dashboard','/alertas','/tarefas','/calendario','/agenda-digital','simulados','/simulados'] },
  { id: 'P8', nome: 'TI', cor: '#1e3a8a', descricao: 'Suporte e gerenciamento de TI', permissoes: ['principal','agenda-digital','academico','financeiro','rh','crm','portaria','administrativo','/administrativo/declaracao-irpf','bi','relatorios','multiUnidades','configuracoes','/dashboard','/alertas','/tarefas','/calendario','/agenda-digital','simulados','/simulados'] },
]
