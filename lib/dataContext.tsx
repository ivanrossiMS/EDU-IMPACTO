...
export const DEFAULT_PERFIS: Perfil[] = [
  ...
  { id: 'P7', nome: 'Administrador', cor: '#4b5563', descricao: 'Acesso administrativo completo', permissoes: ['principal','matriculas','/matriculas/online','/matriculas/valores','agenda-digital','academico','financeiro','rh','crm','portaria','administrativo','/administrativo/declaracao-irpf','bi','relatorios','multiUnidades','configuracoes','/dashboard','/alertas','/tarefas','/calendario','/agenda-digital','simulados','/simulados','/saida-alunos/anunciar'] },
