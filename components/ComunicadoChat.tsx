                ...
                <div key={msg.id} style={{ display: 'flex', gap: 10, position: 'relative' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flexShrink: 0, width: 28 }}>
                    <div style={{ 
                      ...
                      {avatarToUse ? (
                        <img src={avatarToUse} style={{ width: '100%', height: '100%', objectFit: 'cover' }} alt="Avatar" />
                      ) : (
      ...
      <div style={{ display: 'flex', flexDirection: 'column', marginTop: 12, borderTop: '1px solid #f1f5f9', paddingTop: 12 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', gap: 8 }}>
          <div style={{ 
            ...
            {remetenteAvatar ? <img src={remetenteAvatar} style={{ width: '100%', height: '100%', objectFit: 'cover' }} alt="Remetente" /> : remetenteNome.charAt(0).toUpperCase()}
          </div>
